      ...
      <main className="flex-1 px-4 py-6 max-w-lg mx-auto w-full space-y-6">
        ...
        <section className="rounded-2xl border border-zinc-800 bg-zinc-900/30 p-5 space-y-4">
          <div className="flex items-center gap-2 text-indigo-400">
            ...
            <h3 className="font-bold text-white tracking-tight">Security Credentials</h3>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-xl bg-zinc-900/80 border border-zinc-800 pl-10 pr-4 py-3 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-zinc-100"
                required
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                value={formData.pin}
                onChange={handleChange}
                className="w-full rounded-xl bg-zinc-900/80 border border-zinc-800 pl-10 pr-4 py-3 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-zinc-100 tracking-widest font-mono"
                required
              />
            </div>
          </div>
        ...
        <section className="space-y-3">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-rose-500/10 hover:bg-rose-500/20 border border-rose-500/20 text-rose-400 rounded-xl py-3.5 text-xs font-bold active:scale-[0.98] transition-all"
          >
