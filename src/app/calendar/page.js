      ...
      <main className="flex-1 px-4 py-6 max-w-lg mx-auto w-full space-y-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="p-1.5 rounded-lg border border-zinc-800/80 bg-zinc-900/40 text-zinc-400 hover:text-zinc-200 transition-colors"
              >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-indigo-500/10 hover:bg-indigo-500/20 border border-indigo-500/20 text-indigo-400 text-xs font-bold transition-all"
          >
        ...
        <div className="space-y-3">
          {logs.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-10 border border-dashed border-zinc-800 rounded-2xl text-zinc-500">
              <CalendarIcon className="h-8 w-8 mb-2 opacity-40 text-zinc-400" />
            ...
            logs.map(log => {
              ...
              return (
                <div 
                  key={log.id}
                  className="rounded-xl border border-zinc-800/80 bg-zinc-900/10 p-4 flex flex-col gap-2.5"
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-1.5 text-zinc-500 hover:text-indigo-400 transition-colors text-xs font-semibold"
                      >
                        Edit
                      </button>
                      <button
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {log.partner && (
                      <span className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 text-[9px] font-extrabold uppercase tracking-wide">
                        <Users className="h-2.5 w-2.5" />
                        <span>Partner</span>
                      </span>
                    )}
                    {log.porn && (
                      <span className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-rose-500/10 text-rose-400 border border-rose-500/20 text-[9px] font-extrabold uppercase tracking-wide">
                        <Play className="h-2.5 w-2.5" />
                        <span>Pornography</span>
                      </span>
                    )}
                    {!log.partner && !log.porn && (
                      <span className="flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 text-[9px] font-extrabold uppercase tracking-wide">
                  ...
                  {/* Notes */}
                  {log.notes && (
                    <div className="flex items-start gap-1.5 text-xs text-zinc-400 italic bg-zinc-900/30 p-2 rounded-lg border border-zinc-800/40">
